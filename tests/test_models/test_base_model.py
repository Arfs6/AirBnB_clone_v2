...
class TestBaseModel(unittest.TestCase):
    ...
    @unittest.skipIf(isDBStorage,
                     "Can't test save method in db storage")
    ...
    @unittest.skipUnless(isDBStorage,
                         "Skipping the save method test for db storage")
    ...
    @unittest.skipUnless(isDBStorage,
                         "Can't test delete method from base model")
    ...
    def test_clsAttributes(self):
        ...
        self.assertTrue(BaseModel.id.primary_key is True)
        self.assertTrue(BaseModel.id.nullable is False)
        self.assertTrue(BaseModel.created_at.nullable is False)
